...
public class LatestReleasesPortlet extends PortletImpl
{
    ...
    protected Map getVelocityParams(PortletConfiguration portletConfiguration)
    {
        ...
        try {
            ...
            TreeMap latestMap = new TreeMap(Collections.reverseOrder());
            TreeMap futureMap = new TreeMap();
            TreeMap overdueMap = new TreeMap(Collections.reverseOrder());
            ...
            ArrayList latestList = new ArrayList(latestSize.intValue());
            Object[] latestVersions = latestMap.values().toArray();
            ...
            ArrayList futureList = new ArrayList(futureSize.intValue());
            Object[] futureVersions = futureMap.values().toArray();
            ...
            ArrayList overdueList = new ArrayList(overdueSize.intValue());
            Object[] overdueVersions = overdueMap.values().toArray();
