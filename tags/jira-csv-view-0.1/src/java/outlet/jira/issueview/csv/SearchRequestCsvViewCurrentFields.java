...
public class SearchRequestCsvViewCurrentFields extends AbstractSearchRequestCsvView {
    ...
    public SearchRequestCsvViewCurrentFields(JiraAuthenticationContext authenticationContext, SearchProvider searchProvider, TableLayoutFactory tableLayoutFactory) {
